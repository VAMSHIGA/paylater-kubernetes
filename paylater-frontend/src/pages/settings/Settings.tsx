...
export function Settings() {
  ...
  // Get logged-in user, authentication status and logout function
  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      {/* Show merchant profile error if merchant API fails */}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card title="Account" padding="lg" variant="elevated">
          <dl className="space-y-5">
            ...
            {/* Show customer name only for customers */}
            {user?.role === 'customer' ? (
              <div>
                <dt className="text-sm font-medium text-text-muted">
                  Name
        ...
        {/* Show merchant profile only for merchant users */}
        {user?.role === 'merchant' ? (
          <Card
